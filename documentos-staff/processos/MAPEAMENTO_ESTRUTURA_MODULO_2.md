...
- **Exercícios associados**: ✅ **7 exercícios criados**:
  - `lesson-2-2-exercise-1-owasp-zap-setup.md` (Básico)
  - `lesson-2-2-exercise-2-burp-suite-manual.md` (Intermediário)
  - `lesson-2-2-exercise-3-dast-cicd.md` (Intermediário)
  - `lesson-2-2-exercise-4-validate-findings.md` (Avançado)
  - `lesson-2-2-exercise-5-compare-dast-tools.md` (Avançado)
  - `lesson-2-2-exercise-6-baseline-legacy.md` (Intermediário - ⭐ Opcional)
  - `lesson-2-2-exercise-7-optimize-performance.md` (Intermediário - ⭐ Opcional)

#### Vídeo
- **Arquivo**: ❌ **Pendente** - `assets/module-2/videos/2.2-DAST_Testes_Dinamicos.mp4`
- **Título**: *[A ser criado]*
- **Thumbnail**: ❌ **Pendente** - `assets/module-2/images/infograficos/infografico-lesson-2-2.png`
- **Imagem atual**: ✅ `assets/module-2/images/podcasts/2.2-DAST_Testes_Dinamicos.png` (existe)

#### Infográfico
- **Arquivo**: ❌ **Pendente** - `assets/module-2/images/infograficos/infografico-lesson-2-2.png`
...
### Aula 2.2: DAST ✅ **Criados**
- **Vídeo Introdutório**: ❌ **Pendente** - `Exercicios_Seguranca-lesson-2-2-exercises-intro.mp4`
- **Exercícios**: ✅ **7 exercícios criados**:
  1. `lesson-2-2-exercise-1-owasp-zap-setup.md` (Básico)
  2. `lesson-2-2-exercise-2-burp-suite-manual.md` (Intermediário)
  3. `lesson-2-2-exercise-3-dast-cicd.md` (Intermediário)
  4. `lesson-2-2-exercise-4-validate-findings.md` (Avançado)
  5. `lesson-2-2-exercise-5-compare-dast-tools.md` (Avançado)
  6. `lesson-2-2-exercise-6-baseline-legacy.md` (Intermediário - ⭐ Opcional)
  7. `lesson-2-2-exercise-7-optimize-performance.md` (Intermediário - ⭐ Opcional)
...
└── lessons/                    # Aulas do módulo
    ...
    └── exercises/             # ✅ Diretório criado
        ├── lesson-2-1-exercises-intro.md          # ✅ Criado
        ├── lesson-2-1-exercise-1-*.md            # ✅ Criados (5 exercícios)
        ├── lesson-2-2-exercises-intro.md          # ✅ Criado
        ├── lesson-2-2-exercise-1-owasp-zap-setup.md            # ✅ Criado
        ├── lesson-2-2-exercise-2-burp-suite-manual.md          # ✅ Criado
        ├── lesson-2-2-exercise-3-dast-cicd.md                  # ✅ Criado
        ├── lesson-2-2-exercise-4-validate-findings.md         # ✅ Criado
        ├── lesson-2-2-exercise-5-compare-dast-tools.md         # ✅ Criado
        ├── lesson-2-2-exercise-6-baseline-legacy.md            # ✅ Criado (Opcional)
        └── lesson-2-2-exercise-7-optimize-performance.md       # ✅ Criado (Opcional)
...
#### Vídeos das Aulas
```
assets/module-2/videos/
├── 2.1-SAST_Testes_Estaticos.mp4              # ✅ Criado
├── 2.2-DAST_Testes_Dinamicos.mp4              # ❌ Pendente
├── 2.3-Pentest_Basico.mp4                     # ❌ Pendente
├── 2.4-Automacao_Testes_Seguranca.mp4         # ❌ Pendente
└── 2.5-Dependency_Scanning_SCA.mp4            # ❌ Pendente
```

#### Vídeos dos Exercícios
```
assets/module-2/videos/
├── Exercicios_Seguranca-lesson-2-1-exercises-intro.mp4  # ✅ Criado
├── Exercicios_Seguranca-lesson-2-2-exercises-intro.mp4  # ❌ Pendente
├── Exercicios_Seguranca-lesson-2-3-exercises-intro.mp4  # ❌ Pendente
├── Exercicios_Seguranca-lesson-2-4-exercises-intro.mp4  # ❌ Pendente
└── Exercicios_Seguranca-lesson-2-5-exercises-intro.mp4  # ❌ Pendente
```

#### Infográficos
```
assets/module-2/images/infograficos/
├── infografico-introducao-modulo-2.png        # ✅ Criado
├── infografico-lesson-2-1.png                 # ✅ Criado
├── infografico-lesson-2-2.png                 # ❌ Pendente
├── infografico-lesson-2-3.png                 # ❌ Pendente
├── infografico-lesson-2-4.png                 # ❌ Pendente
└── infografico-lesson-2-5.png                 # ❌ Pendente
```

#### Thumbnails/Podcasts
```
assets/module-2/images/podcasts/
├── 2.1-SAST_Testes_Estaticos.png              # ✅ Existe
├── 2.2-DAST_Testes_Dinamicos.png              # ✅ Existe
├── 2.3-Pentest_Basico.png                     # ✅ Existe
├── 2.4-Automacao_Testes_Seguranca.png         # ✅ Existe
└── 2.5-Dependency_Scanning_SCA.png            # ✅ Existe
```
...
### Conteúdo Prático
- **Total de Exercícios**: ✅ **12 exercícios criados** (5 da lesson-2-1 + 7 da lesson-2-2)
  - **Básicos**: 2 (lesson-2-1: 1, lesson-2-2: 1)
  - **Intermediários**: 6 (lesson-2-1: 2, lesson-2-2: 4)
  - **Avançados**: 4 (lesson-2-1: 2, lesson-2-2: 2)
- **Duração Total Estimada dos Exercícios**: ~15-20 horas (lesson-2-1: ~7-9h, lesson-2-2: ~8-10h)

### Vídeos
- **Vídeos de Aulas**: ⚠️ **1 de 5 criados** (lesson-2-1 ✅, lesson-2-2 ❌, lesson-2-3 ❌, lesson-2-4 ❌, lesson-2-5 ❌)
...
- **Total de Infográficos**: ⚠️ **2 de 6 criados**
  - ✅ Infográfico de introdução do módulo
  - ✅ Infográfico lesson-2-1
  - ❌ Infográfico lesson-2-2 (pendente)
  - ❌ Infográfico lesson-2-3 (pendente)
  - ❌ Infográfico lesson-2-4 (pendente)
  - ❌ Infográfico lesson-2-5 (pendente)
...
- Exemplos: ✅ `lesson-2-1-exercise-1-sonarqube-setup`, ✅ `lesson-2-2-exercise-1-owasp-zap-setup`
...
- [x] Exercícios associados (✅ lesson-2-1: 5 exercícios, ✅ lesson-2-2: 7 exercícios)
- [ ] Vídeo introdutório dos exercícios (✅ lesson-2-1 criado, ❌ lesson-2-2 pendente)
...
1. **Status Atual**: 
   - ✅ Aulas teóricas criadas (5 aulas)
   - ✅ Estrutura de diretórios preparada
   - ✅ Exercícios lesson-2-1 criados (5 exercícios)
...
**Última atualização**: Janeiro/2026 - Exercícios lesson-2-1 e lesson-2-2 criados, vídeos e infográficos pendentes
